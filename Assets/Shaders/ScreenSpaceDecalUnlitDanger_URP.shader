Shader "GVX/ScreenSpaceDecalUnlitDanger_URP"
{
	...
	Properties
	{
		...
		_FlashSpeed("Flashing Speed", Float) = 2
	}
		...
		SubShader
		{
			...
			Pass
			{
				...
				half4 UnlitPassFragment(Varyings input) : SV_Target
				{
					...
					albedoAlpha.a *=step(max(absOpos.x, max(absOpos.y, absOpos.z)), 0.5)* progress * ((sin(_Time * _FlashSpeed)*0.5)+0.5);
